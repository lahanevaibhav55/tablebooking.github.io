...
<body>
    ...
    <div class="login_page">
        ...
        <div class="centered">
            <form class="log-in" action="manage-insert.php" method="post">

                <div class="login_box">
                    <div class=" white1">
                        <p class="coustomer_login" style="text-align: center; font-family:'Brygada 1918', serif; font-size: 1.2em;"><b> Customer Login </b></p>
                    ...
                    <button type="submit" class="btn btn-primary" value="Register" name="regascus">Register</button>
